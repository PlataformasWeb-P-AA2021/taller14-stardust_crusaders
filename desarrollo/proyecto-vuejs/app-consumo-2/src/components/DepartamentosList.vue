        ...
        <div v-if="departamentos && departamentos.length">
            <div class="card mb-3" v-for="departamento of departamentos" v-bind:key="departamento.id">
                <div class="row no-gutters">
                    <div class="col-md-4">
                        <div class="card-body">
                            <span class="card-title"><b>Propietario:</b> {{ departamento.nombre_pro }}</span>
                            <br>
                            <span class="card-text"><b>Costo:</b> {{ departamento.costo_depar }}</span>
                            <br>
                            <span class="card-text"><b>Número de cuartos:</b> {{ departamento.numero_cuar }}</span>
                            <br>
